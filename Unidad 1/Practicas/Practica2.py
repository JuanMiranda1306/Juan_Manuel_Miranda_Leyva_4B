...
class cuenta_bancaria:
    ...
    def depositar(self,cantidad):
        if cantidad>0:
            ...
            print(f"Se deposito la cantidad de ${cantidad} a la cuenta,nuevo saldo de ${self.__saldo}")
        else:
    ...
    def retirar (self,cantidad):
        if cantidad <self.__saldo:
            self.__saldo -=cantidad
            print(f"Se retiro la cantidad de ${cantidad} de su cuenta, saldo restante de ${self.__saldo}")
        else:
            print("Error en el retiro, saldo insuficiente o intentelo de nuevo")
